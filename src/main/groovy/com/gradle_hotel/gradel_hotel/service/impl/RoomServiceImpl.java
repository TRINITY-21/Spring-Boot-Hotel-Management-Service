...
import com.gradle_hotel.gradel_hotel.mapper.RoomMapper;
...
import com.gradle_hotel.gradel_hotel.service.AwsS3Service;
...
public class RoomServiceImpl implements IRoomService {
    ...
    public ResponseData getAvailableRoomsByDataAndType(LocalDate checkInDate, LocalDate checkOutDate, String roomType) {
        ...
        System.out.println(roomType + "" + checkInDate + "datesss " + checkOutDate);
        try {
            List<Room> availableRooms = roomRepository.findAvailableRoomsByDatesAndTypes(checkInDate, checkOutDate, roomType);
            System.out.println(availableRooms + "available rooms");
